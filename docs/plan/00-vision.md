...
| P5 | **Tutor / coaching center** ("Mr. Okafor, Lagos") | Runs small IELTS classes; wants tools students can use at home for free | Assignable practice, inspectable transcripts/essays with AI first-pass feedback | Free redistribution (MIT); exportable session reports; original content bank he can extend |
